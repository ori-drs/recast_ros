...
public:
	...
	void setBuildSettings(const BuildSettings& settings, bool replaceBounds=false);
	bool load(class rcContext* ctx, const pcl::PolygonMesh& pclMesh, bool needToRotateMesh=false);
